    ...
    findUser: async (id, googleSub, email) => {
      ...
      if (pool) {
        try {
          ...
          console.warn("[store] findUser DB query skipped:", err.message);
        }
      }
      return null;
    },
    findSession: async (userId, jti) => {
      ...
      if (pool) {
        try {
          ...
          console.warn("[store] findSession DB query skipped:", err.message);
        }
      }
      return null;
    },
    findFile: async (id) => {
      ...
      if (pool) {
        try {
          ...
          console.warn("[store] findFile DB query skipped:", err.message);
        }
      }
      return null;
    },
    findFolder: async (id) => {
      ...
      if (pool) {
        try {
          ...
          console.warn("[store] findFolder DB query skipped:", err.message);
        }
      }
      return null;
    }
