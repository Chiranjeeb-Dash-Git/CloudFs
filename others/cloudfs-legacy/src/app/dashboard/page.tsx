      ...
      <main className="relative z-10 mx-auto flex min-h-screen max-w-[1280px] flex-col px-6 py-10">
        ...
        <section className="grid grid-cols-1 gap-5 md:h-[600px] md:grid-cols-12">
              ...
              <article className="panel h-full min-h-[160px]">
                <div className="panel-inner flex flex-col justify-between p-7">
                  ...
                  <div className="mt-6 flex gap-2">
                    <button className="flex flex-1 items-center justify-center gap-2 rounded-full border border-hairline bg-surface-2 px-4 py-2.5 text-xs transition-colors duration-300 hover:bg-accent">
          ...
          <Reveal className="md:col-span-4" delay={100} parallax={50}>
            <article className="panel group h-[420px] cursor-pointer md:h-full">
        ...
        <section className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-3">
          {[
            { icon: Link2, label: "Public links · expiry + password", cta: "Manage" },
            { icon: Star, label: "Starred · 6 items", cta: "View" },
            { icon: Trash2, label: "Trash · 30-day retention, 12 items", cta: "Open" },
          ].map(({ icon: Icon, label, cta }, i) => (
            <Reveal key={label} delay={i * 90}>
              <div className="flex items-center justify-between rounded-2xl border border-hairline bg-surface px-6 py-4 transition-colors duration-300 hover:bg-surface-2">
                ...
                <button className="text-xs text-muted-foreground transition-colors duration-300 hover:text-foreground">
                  {cta} →
                </button>
              </div>
            </Reveal>
